...
#
@test "Test where mrc file is invalid" {
  ...
  echo ""
  [ "${lines[0]}" == "simple.error.message=Problems checking validity of MRC file" ]
  [ "${lines[1]}" == "detailed.error.message=Non zero exitcode (1) from $THE_TMP/bin/command info $THE_TMP/foo/data/yo.mrc : error" ]
